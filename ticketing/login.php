                        ...
                        <div class="login-wrap p-4 p-lg-5">
                            ...
                            <form action="" class="signin-form" method="POST">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="firstname" class="form-control" placeholder="Username" required value="<?php if (isset($_POST['firstname'])) {
                                                                                                                                        echo $firstname;
                                                                                                                                    } ?>">
                                    <span style="color:red;"> <?php if (isset($_POST['firstname'])) {
                                                                    echo $firstnameErr;
                                                                } ?></span>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="lastname" class="form-control" placeholder="Username" required value="<?php if (isset($_POST['lastname'])) {
                                                                                                                                        echo $lastname;
                                                                                                                                    } ?>">
                                    <span style="color:red;"> <?php if (isset($_POST['lastname'])) {
                                                                    echo $lastnameErr;
                                                                } ?></span>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Reg_number" value="<?php
